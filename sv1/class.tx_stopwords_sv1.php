...
/**
 * Service "White lists/Black lists" for the "stopwords" extension.
 *
...
class tx_stopwords_sv1 extends t3lib_svbase {
	...
	public $scriptRelPath = 'sv1/class.tx_stopwords_sv1.php';	// Path to this script relative to the extension dir.
	public $extKey = 'stopwords';	// The extension key.
	...
	/**
	 * This method loads a given stopwords record for checking
	 * The $parameters array is expected to contain a "uid" index which
	 * points to the uid of a stopwords record
	 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/stopwords/sv1/class.tx_stopwords_sv1.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/stopwords/sv1/class.tx_stopwords_sv1.php']);
}
